...
export default function Home() {
  ...
  const { jobs: recentJobs, loading: jobsLoading } = useJobs({ limit: 6 });

const { products: recentProducts, loading: productsLoading } = useProducts({
  limit: 6,
});
      ...
      <section className="hero">
        <div className="hero-inner">
          <div className="hero-text">
            ...
            <p className="hero-p">
              Бишкек, Ош, Жалал-Абад жана башка шаарларда —
        ...
        <div className="container">
          <div className="sec-head">
            <div>
              ...
              <p className="sec-sub">
                Иш же товар табуу үчүн категория тандаңыз
              </p>
            </div>
          </div>
            ...
            {categories.map((cat, i) => {
              ...
              return (
                <div
                  ...
                  onClick={() =>
                    navigate(cat.type === "job" ? "/jobs" : "/market")
                  }
                >
        ...
        <div className="container">
          ...
          {jobsLoading ? (
            ...
            <div className="home-empty">
              <p>Азырынча иш жарнамалары жок</p>
              <button onClick={() => navigate("/post/new?type=job")}>
                Биринчи болуп жарнама бериңиз
              </button>
            </div>
          ) : (
              ...
              {recentJobs.map((job, i) => (
                ...
                >
                  ...
                  <div className="jr-right">
                    ...
                    <span
                      className={`jr-type ${
                        job.job_type === "remote" ? "remote" : "full"
                      }`}
                    >
      ...
      <section className="section" ref={productsRef}>
        <div className="container">
          ...
          {productsLoading ? (
            ...
            <div className="home-empty">
              <p>Азырынча товарлар жок</p>
              <button onClick={() => navigate("/post/new?type=product")}>
                Биринчи болуп товар сатыңыз
              </button>
            </div>
          ) : (
            ...
            {[
              {
                ...
                icon: <IconUsers />,
                title: "Катталуу",
                desc: "Бекер катталып, профилиңизди бир мүнөттө толтуруңуз",
              },
              {
                n: "02",
                icon: <IconBriefcase />,
                title: "Жарнама жайгаштыруу",
                desc: "Иш же товар жөнүндө жарнама жазып, сүрөт кошуңуз",
              },
              {
                n: "03",
                icon: <IconCheck />,
                title: "Байланышуу",
                desc: "Кызыккандар менен түз байланышып, макулдашыңыз",
              },
            ].map((s, i) => (
              <div
                key={i}
                className={`step ${stepsInView ? "visible" : ""}`}
                style={{ "--d": `${i * 0.15}s` }}
              >
          ...
          <div className="cta-inner">
            <div className="cta-text">
              ...
              <ul className="cta-list">
                {[
                  "Бекер катталуу",
                  "Жарнаманы бир мүнөттө жайгаштыруу",
                  "Сатуучулар менен түз байланыш",
                ].map((t) => (
                  <li key={t}>
                    <IconCheck />
                    {t}
